...
public class AlertView {
    ...
    private Typeface titleStyle;
    private String msg;
    public int msgColor = R.color.textColor_actionsheet_msg;
    ...
    private int cancelColorId;//取消按钮颜色
    private int otherColorId;//其他按钮颜色
    ...
    public AlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, OnItemClickListener onItemClickListener) {
        this(title, msg, cancel, destructive, others, context, style, onItemClickListener, 0, 0);
    }

    public AlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, OnItemClickListener onItemClickListener, int cancelColorId, int otherColorId) {
        this.cancelColorId = cancelColorId;
        this.otherColorId = otherColorId;
...
//                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.margin_alert_left_right);
                margin_alert_left_right = context.getResources().getDimensionPixelOffset(R.dimen.margin_actionsheet_left_right_test);
    ...
    protected void initHeaderView(ViewGroup viewGroup) {
        ...
        if (title != null) {
            ...
            tvAlertTitle.setTypeface(titleStyle);
        } else {
            tvAlertTitle.setVisibility(View.GONE);
        }
        if (msg != null) {
            tvAlertMsg.setText(msg);
            tvAlertMsg.setTextColor(context.getResources().getColor(msgColor));
        } else {
    ...
    protected void initListView() {
        ...
        if (cancel != null && style == Style.Alert) {
            View itemView = LayoutInflater.from(context).inflate(R.layout.item_alertbutton_new, null);
            ...
            tvAlert.setTextColor(context.getResources().getColor(this.cancelColorId != 0 ? this.cancelColorId : R.color.bgColor_actionsheet_cancel_nor));
        ...
        AlertViewAdapter adapter = new AlertViewAdapter(mDatas, mDestructive, otherColorId, !(title == null && msg == null));
        ...
        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (onItemClickListener != null && AlertView.this != null)
        ...
        if (mDatas.size() <= HORIZONTAL_BUTTONS_MAXCOUNT) {
            ...
            for (int i = 0; i < mDatas.size(); i++) {
                ...
                if (i != 0) {
                    ...
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int) context.getResources().getDimension(R.dimen.size_divier_07), LinearLayout.LayoutParams.MATCH_PARENT);
                ...
                if (data == cancel) {
                    tvAlert.setTypeface(Typeface.DEFAULT_BOLD);
                    tvAlert.setTextColor(context.getResources().getColor(this.cancelColorId != 0 ? this.cancelColorId : R.color.textColor_alert_button_destructive));
                    tvAlert.setOnClickListener(new OnTextClickListener(CANCELPOSITION));
                    position = position - 1;
                } else if (otherColorId != 0) {
                    tvAlert.setTextColor(context.getResources().getColor(otherColorId));
                }
                //高亮按钮的样式
     ...
     */
    public void show() {
        setStatusBarColor(R.color.bgColor_overlay_status_bar);
        if (isShowing()) {
            return;
        }
        onAttached(rootView);
    ...
    public void dismissImmediately() {
        setStatusBarColor(R.color.bgColor_actionsheet_cancel_nor);
    ...
    private void setStatusBarColor(int colorId) {
        ...
        StatusBarCompat.setStatusBarColor((Activity) contextWeak.get(), contextWeak.get().getResources().getColor(colorId));
    }
    ...
    public static class Builder {
        ...
        private Typeface titleStyle;
        private String msg;
        private int msgColor = R.color.textColor_alert_msg;
        private String cancel;
        private String[] destructive;
        private String[] others;
        private OnItemClickListener onItemClickListener;
